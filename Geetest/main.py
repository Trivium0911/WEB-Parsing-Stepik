...
def main():
    ...
    with uc.Chrome(version_main=112, seleniumwire_options=proxy) as browser:
        ...
        if slider:
            ...
            time.sleep(5)
        articles = [int(i.find_element(By.TAG_NAME, "ul").find_element(By.TAG_NAME, "li").text.replace("Артикул: ", "")) for i in browser.find_elements(By.CLASS_NAME, "css-1ecvsm5")]
        print(sum(articles))
